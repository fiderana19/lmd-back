...
exports.exceptionList = void 0;
exports.exceptionList = [
    {
        code: 400,
    ...
    },
    {
        ...
        message: 'This response is sent when the web server, after performing server-driven content negotiation, did not find any content that conforms to the criteria given by the user agent.',
