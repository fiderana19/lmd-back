...
router.get("/", (req, res) => {
  ...
  db.query(SELECT_NOTE_QUERY, (err, data) => {
    if (err) {
      console.log(err);
      return res.json(err);
    }
...
router.get("/note/:id", (req, res) => {
  ...
  db.query(SELECT_NOTE_QUERY, [id], (err, data) => {
    if (err) {
      console.log(err);
      return res.json(err);
    }
...
router.patch("/edit/:id", (req, res) => {
  ...
  db.query(UPDATE_NOTE_QUERY, [valeur, id], (err, data) => {
    if (err) {
      console.log(err);
      return res.json(err);
    }
...
router.delete("/delete/:id", (req, res) => {
  ...
  db.query(DELETE_NOTE_QUERY, [id], (err, data) => {
    if (err) {
      console.log(err);
      return res.json(err);
    }
...
router.get("/notes/etudiant/:id_etudiant", (req, res) => {
  ...
  const SELECT_NOTES_BY_STUDENT_QUERY =
    "SELECT * FROM note WHERE id_etudiant = ?";

  db.query(SELECT_NOTES_BY_STUDENT_QUERY, [id_etudiant], (err, data) => {
    if (err) {
      console.log(err);
      return res.json(err);
    }
...
router.get("/notes/etudiant/:id_etudiant/niveau/:id_niveau", (req, res) => {
  ...
  const SELECT_NOTES_BY_STUDENT_AND_LEVEL_QUERY =
    "SELECT * FROM note WHERE id_etudiant = ? AND id_niveau = ?";
...
router.get("/etudiant/:id_etudiant/annee/:annee", (req, res) => {
  ...
  const SELECT_NOTES_BY_STUDENT_AND_YEAR_QUERY =
    "SELECT * FROM note WHERE id_etudiant = ? AND YEAR(date) = ?";
...
router.post("/niveau/", (req, res) => {
  ...
  db.query(SELECT_NOTE_NIVEAU, [id_ec, id_niveau, id_annee], (err, data) => {
    if (err) {
      console.log(err);
      return res.json(err);
    }
